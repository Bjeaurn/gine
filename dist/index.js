(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("gine2", ["rxjs"], factory);
	else if(typeof exports === 'object')
		exports["gine2"] = factory(require("rxjs"));
	else
		root["gine2"] = factory(root["rxjs"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_8__) {
return webpackJsonpgine2([0],[
/* 0 */
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(9), __webpack_require__(10), __webpack_require__(0), __webpack_require__(8), __webpack_require__(11), __webpack_require__(13), __webpack_require__(23), __webpack_require__(24)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, image_1, text_1, config_1, rxjs_1, canvas_1, keyboard_1, mouse_1, camera_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var sprite = new image_1.SpriteAsset('test', 'sprites/coin-sprite-animation-sprite-sheet.png', { widthPerImage: 1, heightPerImage: 1 });
    var Main = (function () {
        function Main(config) {
            ...
            var ticks = rxjs_1.Observable.interval(this.tickMs).map(function () { return 'tick'; });
            var frames = rxjs_1.Observable.interval(this.fpsMs).map(function () { return 'frame'; });
            var seconds = rxjs_1.Observable.interval(1000).map(function () { return 'second'; });
            this.update$ = rxjs_1.Observable.merge(ticks, frames, seconds)
                .share();
        }
        ...
        Main.prototype.fn = function (type) {
            if (type === 'frame')
                this.frame();
            if (type === 'tick')
                this.tick();
    ...
    exports.Main = Main;
    var app = new Main(config_1.CONFIG);
    app.start();
    var camera = new camera_1.Camera();
    var keyboard = new keyboard_1.Keyboard(app.canvas.canvas);
    var mouse = new mouse_1.Mouse(app.canvas.canvas);
}.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(12), __webpack_require__(0)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, handle_1, config_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Canvas = (function () {
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(2)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, Observable_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
